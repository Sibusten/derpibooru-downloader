...
void MainWindow::showAbout() {
	...
	messageBox->setText(
		"<html><body>Derpibooru Downloader v" + VERSION +
...
void MainWindow::on_startButton_clicked() {
	...
	manager->start(
		getSearchSettings(),
		ui->imageFileNameFormat->text(),
		limitImagesDownloaded,
		ui->saveJson->isChecked(),
		ui->updateJson->isChecked(),
		ui->jsonFileNameFormat->text(),
		static_cast<DownloadManager::SVGMode>(ui->buttonGroupSVGOptions->checkedId()),
...
DerpiJson::SearchSettings MainWindow::getSearchSettings()
{
	...
	return DerpiJson::SearchSettings(
		query,
		ui->startingPage->value(),
		ui->imagesPerPage->value(),
		ui->includeComments->isChecked(),
		ui->includeFavorites->isChecked(),
		ui->searchFormat->currentIndex(),
