...
public slots:
    void start(DerpiJson::SearchSettings searchSettings, QString imageFileNameFormat, int maxImages = -1, bool saveJson = false,
            bool updateJson = false, QString jsonFileNameFormat = "", SVGMode svgMode = saveSVG, bool jsonOnly = false);
...
private:
    ...
    bool imageWaiting;       // Whether the image function is waiting due to a network error.
